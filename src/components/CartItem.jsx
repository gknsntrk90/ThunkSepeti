...
const CartItem = ({ item }) => {
  ...
  //* Artı butona tıkladığımızda dispatch ile updateItem aksiyonunu tetikle ve reducer'a haber ver.
        ...
        <div className="flex justify-between">
          ...
          <div className="border rounded-xl text-lg">
            <button
              ...
              className="hover:bg-red-100 p-3 rounded-xl transition text-red-500"
            >
